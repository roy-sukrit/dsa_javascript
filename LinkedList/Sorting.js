...
class LinkedList {
    ...
    partitionList(x) {
        let smallerNode = new Node(0);
        let biggerNode = new Node(0);
    
        let smallerHead = smallerNode;
        let biggerHead = biggerNode;
        ...
        console.log("Final smallerNode list", smallerHead.next);
        console.log("Final biggerNode list", biggerHead.next);
    }
